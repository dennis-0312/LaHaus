 ...
 */
define(["N/record", "N/search", "N/file", "N/https", "N/runtime", "N/url", "N/https"],

    function (record, search, file, https, runtime, url, https) {
        ...
        function execute(scriptContext) {
            ...
            try {
                ...
                // ID_TRANSACTION = 188259;

                TYPE_TRANSACTION = "creditmemo";
                ID_TRANSACTION = 222903;
                ...
                log.debug('employeeResult', employeeResult);
                ...
                for (var i = 0; i < lineTransaction; i++) {
                    ...
                    if (typeItem !== 'Discount') {
                        ...
                        if (iswht) {
                            ...
                            log.debug('tasaRetencion', tasaRetencion);
                ...
                if (TYPE_TRANSACTION != 'invoice') {
                    ...
                    if (nmroDocRel == 'NULL' || nmroDocRel == 'null') {
                        log.debug('no hay documento referenciado', 'no hay documento referenciado');
